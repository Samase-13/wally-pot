    ...
    productosElegidos.forEach(producto => {
        ...
        div.innerHTML = `
            ...
            <div class="producto-detalles">
                ...
                <button class="producto-ver" data-id="${producto.id}">Ver</button>
            </div>
        `;
...
function verProducto(productoId) {
    // Abrir la página de visualización del producto en una nueva pestaña
    window.open(`VistaProducto.html?id=${productoId}`, '_blank');
}
